...
Les méthodes d'interpolation de Lagrange et de Neville permettent d'obtenir un même polynôme pour un même jeu de données.\\
Pour approcher une fonction avec des polynômes, on peut préférer utiliser des polynômes par morceaux. Dans ce cas, pour améliorer l'interpolation, on augmente le nombre de morceaux et non le degré des polynômes. (Segmentation)\\
